...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME =
      'blaze-out/k8-opt/genfiles/third_party/mediapipe/examples/web/autoflip_web/autoflip_live_packed_assets.data';
    var REMOTE_PACKAGE_BASE = 'autoflip_wasm/autoflip_live_packed_assets.data';
    if (
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](
          'datafile_blaze-out/k8-opt/genfiles/third_party/mediapipe/examples/web/autoflip_web/autoflip_live_packed_assets.data',
        );
      }
  ...
  loadPackage({
    ...
    package_uuid: '6e9b6733-985b-4911-be18-7b50138f9b28',
    files: [
      {
